...
let OrdenRepository = class OrdenRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Orden, dataSource);
    }
};
OrdenRepository = (0, tslib_1.__decorate)([
